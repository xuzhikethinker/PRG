...
public class TextReader extends FilterReader {
    ...
    * <p>Pointer is moved over white space.
    * @return true if next non-white space character is end of line or end of file.
    */
   public boolean eoln() {
      char ch = lookChar();
   ...
   /**
    * Tests to se if next non-white space character is end of file.
    * <p>Pointer is moved over white space and end of lines.
    * @return true if next non-white space character or non-eol characters is end of line or end of file.
    */
   public boolean eof() {
      char ch = lookChar();
      while (!EOF && !errorFlag && (ch == ' ' || ch == '\n' || ch == '\t')) {
