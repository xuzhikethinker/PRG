...
public class Projections {
     ...
     * If a label is not present in <code>partition[]</code> a disconnected vertex will still be created.
     ...
     * <p>If the old graph is undirected then self-loops in the new graph coming 
     ...
     * @param makeUnweighted true if want to force unweighted new graph
     */
    public static timgraph ontoVertexPartition(String rootName, timgraph oldtg, 
            int [] partition, int numberPartitions, 
            boolean forceUndirected, boolean makeUnweighted) 
    {
    ...
    /**
     * 
     * @param tg graph to be reduced
     * @param addToRoot string to add to root name
     * @param oldToNewVertexMap global vertex to global vertex index
     * @param forceUndirected true if want to force undirected new graph
     * @param makeUnweighted true if want to force unweighted new graph
     * @return 
     */
    public static timgraph eliminateVertexSet(timgraph tg, String addToRoot, 
            Map<Integer,Integer> oldToNewVertexMap, 
            boolean forceUndirected, boolean makeUnweighted){
     // remember to look for type 2 start if bipartite
     return null;   
    }
