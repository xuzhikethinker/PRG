 ...
 */
    public QualityMinimalMemory(timgraph graph, int qdef, int nullModel, double newlambda, int infoLevelNew){
...
//        for (int v=0; v<numberVertices; v++) totalWeight+=graph.getVertexOutStrength(v);
    ...
    public double get(int s, int t){
        ...
        switch (nullModelSwitch){
                    case 5:
                        nullModelValue = 1.0/graph.getTotalWeight();// nullModelNorm;
                        break;
                    case 4:
