...
public Community(){}
     ...
     *null model set by directed nature of graph.
...
public Community(timgraph tg, int qdef, double newlambda, int qualityType, int newInfoLevel){
     ...
     * @see TimGraph.Community.Quality#nullModelSwitch
     */
public Community(timgraph tg, int qdef, int nullModel, double newlambda, int qualityType, int newInfoLevel){
    infoLevel=newInfoLevel;
    initialiseGraph(tg, qdef,  nullModel, qualityType, newlambda);
}
...
// */
//    public Community (timgraph tg, Partition p, int qdef, int nullModel, int qualityType, double newlambda){
//      initialiseGraph(tg, qdef,  nullModel, qualityType, newlambda);
//    }
//    
 ...
 * @see TimGraph.Community.Quality#nullModelSwitch
 */
    public void initialiseGraph(timgraph tg, int qdef, int nullModel, int qualityType, double newlambda){
            graph =tg;
            quality = QualityType.makeQuality(tg, qdef, nullModel, qualityType, newlambda, infoLevel);
            Q = UNSET;
    }
