 ...
 */
     public class Coordinate
    {
     ...
     double z;
     /**
      * Label used to head column of x positions in files.
      */
     public static final String XLabel="xPos";
     /**
      * Label used to head column of y positions in files.
      */
     public static final String YLabel="yPos";
     /**
      * Label used to head column of z positions in files.
      */
     public static final String ZLabel="zPos";
     ...
     public Coordinate()
        ...
        /**
         * Add to coordinate.
         * Z coordinate left unchanged
         * @param xxx add to x coordinate
         * @param yyy add to y coordinate
         */
        public void add(double xxx, double yyy){
          x+=xxx;
          y+=yyy;
        }
         ...
         * @param xxx add to x coordinate
         * @param yyy add to y coordinate
         * @param zzz add to z coordinate
         */
        public void add(double xxx, double yyy, double zzz){
          x+=xxx;
          y+=yyy;
          z+=zzz;
        }
        /**
         * Scale coordinates.
         * Each coordinate is multiplies by the scaling factor
         * @param scalingFactor
         */
        ...
        static public String labelString(String sep){
            return XLabel+sep+YLabel+sep+ZLabel;
        }
       ...
       public static double calcLength2D(Coordinate s,  Coordinate t){
