...
public class General {
    ...
    static public void processSections(int n, int outputMode, boolean basicAnalysis, String [] args){
      ...
      unitg.calcStrength();
      int nullModel=(unitg.isDirected()?4:0); 
      LineGraphCommunities.analyseGraph(unitg, method, lgmethod, qdef, nullModel, qualityType, lambda);
...
//    LineGraphCommunities.analyseGraph(termg, method, lgmethod, qdef, qualityType, lambda);
    ...
    static public void processOriginalFile(int n, int outputMode, boolean basicAnalysis, double lambda, String [] args)
    {
      ...
      //double lambda=1.0; //value of lambda, scaling parameter of null model.
      termg.calcStrength();
      int nullModel=(termg.isDirected()?4:0); 
      LineGraphCommunities.analyseGraph(termg, method, lgmethod, qdef, nullModel, qualityType, lambda);
      paperg.calcStrength();
      nullModel=(paperg.isDirected()?4:0); 
      LineGraphCommunities.analyseGraph(paperg, method, lgmethod, qdef, nullModel, qualityType, lambda);
