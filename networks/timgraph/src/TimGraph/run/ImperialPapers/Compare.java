...
public class Compare {
    ...
    { 
      ...
      TreeMap<String,Integer>vertexNameToIndex = tg1.getVertexNameToIndexMap();
      ...
      int nullModel=(tg1.isDirected()?4:0);
      VertexCommunity vc1 =  new VertexCommunity (tg1, vp1, qdef, nullModel, qualityType, lambda);
