...
//     String [] aList = { "-fin"+basicFileName,"-fisinput/Test","-fosoutput/Test","-o7", "-xv10", "-xe20"};
     //String basicFileName="UKwardsSEJDinputELS.dat";
     //String [] aList = { "-fin"+basicFileName,"-fisinput/UKwards","-fosoutput/UKwards", "-o511", "-gdt", "-gewt", "-gvlt", "-gest", "-gvlt"};
//     String basicFileName="TestCommutingFlowinputELS.dat";
//     String [] aList = { "-fin"+basicFileName,"-fisinput/UKwards","-fosoutput/UKwards", "-o511", "-gdt", "-gewt", "-gvlt", "-gest", "-gvlt"};
...
//     String [] aList = { "-fin"+basicFileName,"-fisinput/UKwards","-fosoutput/UKwards", "-o0"};
//     String basicFileName="testdslinputELS.dat";
//     String [] aList = { "-fin"+basicFileName, "-o3"};
