 ...
 * @author time
 */
public class NetworkGeneratorAegean {
    String SEP = "\t";
    ...
    /**
     * Creates a new instance of NetworkGeneratorAegean.
     */
    public NetworkGeneratorAegean() 
    {
     ...
     */
    public NetworkGeneratorAegean(int inputType, int number,  double inputscale) 
    {
