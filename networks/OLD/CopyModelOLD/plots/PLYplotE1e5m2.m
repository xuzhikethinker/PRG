...
NActive =[];
titlename='PLY m2 E=1e5 t1e6 r1e3';
filenamemasterroot='PLYm2et10000000ni100000na100000';
% *** **********************************************
nnn=1;
pp(nnn)=0.9;
pr= 1-pp(nnn);
...
pp(nnn)=0.9999;
pr= 1-pp(nnn);
filenameroot=[filenamemasterroot,'pp0.9999pr0.0001'];
...
filenameroot=[filenamemasterroot,'pp0.99999pr0.00001'];
