...
pp(1)=0.9;
NActive =[];
titlename='BCM m0 E1e5';
filenamemasterroot='BCMm0et5000000ni10000na10000';
filenameroot=[filenamemasterroot,'pp0.9pr0'];
pr= 1-pp(1);
...
pp(2)=0.99;
pr= 1-pp(2);
filenameroot=[filenamemasterroot,'pp0.99pr0'];
...
pp(5)=0.99999;
pr= 1-pp(5);
filenameroot=[filenamemasterroot,'pp0.99999pr0'];
[NA,M5,V5] = DataProcess (filenameroot,kav,E,pr);
DD5= DegreeDistribution(kvector,kav,E,pr);
NActive=[NActive,NA];
pp(6)=0.999999;
pr= 1-pp(6);
filenameroot=[filenamemasterroot,'pp0.999999pr0'];
