% Plot out BHS E1e5 m2 Bentley Copy Model Results
...
pp(1)=0.9;
NActive =[];
titlename='BHS m2 E1e5';
filenamemasterroot='BHSm2et5000000ni100000na100000';
filenameroot=[filenamemasterroot,'pp0.900pr0.0'];
pr= 1-pp(1);
...
pp(2)=0.99;
pr= 1-pp(2);
filenameroot=[filenamemasterroot,'pp0.990pr0.0'];
