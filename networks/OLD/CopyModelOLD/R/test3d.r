...
testtable4a <- read.table("up-tt20000-tu100-te1-ni100-na100-pp0.01-mr4r9999t20000.tdatanh.dat", header=TRUE, sep ="\t", comment.char = "", fill=TRUE)
testtable4b <- read.table("up-tt20000-tu100-te50-ni100-na100-pp0.01-mr4r9999t20000.tdatanh.dat", header=TRUE, sep ="\t", comment.char = "", fill=TRUE)
...
testtable5a <- read.table("up-tt20000-tu100-te1-ni100-na100-pp0.01-mr5r9999t20000.tdatanh.dat", header=TRUE, sep ="\t", comment.char = "", fill=TRUE)
testtable5b <- read.table("up-tt20000-tu100-te50-ni100-na100-pp0.01-mr5r9999t20000.tdatanh.dat", header=TRUE, sep ="\t", comment.char = "", fill=TRUE)
...
testtable6a <- read.table("up-tt20000-tu100-te1-ni100-na100-pp0.01-mr6r9999t20000.tdatanh.dat", header=TRUE, sep ="\t", comment.char = "", fill=TRUE)
testtable6b <- read.table("up-tt20000-tu100-te50-ni100-na100-pp0.01-mr6r9999t20000.tdatanh.dat", header=TRUE, sep ="\t", comment.char = "", fill=TRUE)
...
testtable7a <- read.table("up-tt20000-tu100-te1-ni100-na100-pp0.01-mr7r9999t20000.tdatanh.dat", header=TRUE, sep ="\t", comment.char = "", fill=TRUE)
testtable7b <- read.table("up-tt20000-tu100-te50-ni100-na100-pp0.01-mr7r9999t20000.tdatanh.dat", header=TRUE, sep ="\t", comment.char = "", fill=TRUE)
...
points(testtable5b[,1],testtable5b[,17], col=colourlist[2])
points(testtable5c[,1],testtable5c[,17], col=colourlist[3])
