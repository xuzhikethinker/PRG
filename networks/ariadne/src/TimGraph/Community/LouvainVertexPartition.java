...
public class LouvainVertexPartition extends VertexPartition {
    ...
    //private VertexPartition bestCommunity;
    ...
    initialise(tg,qdef,qualityType,true);
    infoLevel=infolevel;
     ...
     */
    public LouvainVertexPartition(timgraph tg, int qdef, int qualityType, double lambda,
            int infolevel, int maxNumberCommunities){
    infoLevel=infolevel;
    initialise(tg,qdef, qualityType,lambda, maxNumberCommunities);
    name="Louvain"+quality.QdefinitionShortString();
    }
...
//            timgraph projg = new timgraph(graph,communityOfElement, numberCommunities, false, false);
            ...
            LouvainVertexPartition projLC = new LouvainVertexPartition(projg, quality.Qdefinition, quality.getQualityTypeNumber(), quality.lambda, infoLevel,-1 );
