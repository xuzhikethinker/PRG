...
/*   
    This file defines the Class TextReaderTabSeparated as a subclass of FilterReader..
...
/**
 * This is an altered version of the TextReader class of David Eck.
 * <p>Words are now only padded by spaces so that tab characters or an eoln 
 * always mark the end and start of a word.  Note that each row in a a tab separated file
 * ends with an eoln not a tab.
 * @author time
 */
public class TextReaderTabSeparated extends FilterReader {
   ...
   public boolean getBoolean() { errorFlag = false; return readBoolean(); }
    /**
    * TSE altered so does not skip white space.
    * <p>This does not deal with consecutive tabs.
    * @return string with word conatined within
     * @deprecated DOES NOT WORK USEFULLY, use getWordIncludingNulls()  
    */
   public String getWordWithSpaces()     { errorFlag = false; return readWordWithSpaces(); }
    /**
    * TSE altered so does not skip spaces.
    * <p>This means that consecutive tabs or eol contain a null string.
     * Spaces at start or anyweher in between tabs, eol and eof are treated as part of the word.
    * @return the next string between tabs, eol or eof.
    */
   public String getWordIncludingSpaces()     { errorFlag = false; return readWordIncludingSpaces(); }
   ...
   /**
    * Tests to see if next non-white space character is end of line or end of file.
    * <p>Pointer is moved over spaces. TSE altered
    * @return true if next non-space character is end of line or end of file.
    */
   public boolean eoln() {
      char ch = lookChar();
   ...
   /**
    * Tests to see if next character is end of file.
    * <p>Pointer is moved over end of line characters.
    * @return true if next non-eol character is end of file.
    */
   public boolean eof() {
      char ch = lookChar();
      while (!EOF && !errorFlag && ( ch == '\n' )) {
   ...
   /**
    * TSE removed space test
    * @return
    * @deprecated use skipWhiteSpaceNotTabs()
    */
  public void skipWhiteSpaceNotSpaces() {
   ...
   /**
    * TSE altered tab test
    * <p>This will skip only spaces and  end of lines
    */
...
// *************************** private implementation stuff ***********************
   ...
   protected boolean errorFlag = false;    // set to true if most recent operation produced an error
   private String errorMessage = "";     // error message for the most recent error
   protected boolean EOF = false;          // has the end-of-stream been encountered?
    ...
    * 
    * @return
    * @deprecated TSE use readWordIncludingNulls()
    */
   ...
   /**
    * Treats eol, eof and  tabs as end of a word. 
    * <p>Does not ignore the spaces at the start of a word.
    * @return
    */
   private String readWordIncludingSpaces() {
      ...
      if (ch =='\t' || ch != '\n') readChar(); // start at beginning of next cell
      return s.toString();
   }
