 ...
 * (pointLineTest).
 * <p>Adapted by TSE to allow index of point to be stored.
 */
public class Point_dt {
	...
	/**
         * Constructs a 3D point with a z value of 0 and given index.
         * @param x x coordinate
         * @param y y coordinate
         * @param z z coordinate
         * @param islandNetworkIndex index of point
         */
	public Point_dt(double x, double y, double z, int index) {
		this(x, y, z);
                this.index=index;
	}
