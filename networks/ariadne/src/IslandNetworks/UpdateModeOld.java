 ...
 */
   public class UpdateModeOld {
    ...
    /** Creates a new instance of UpdateModeOld.
     *@param mode integer value referring to mode
     */
    public UpdateModeOld(int mode) {
        setMode(mode);     
    }
     ...
     */
    public UpdateModeOld(String s) {
        setMode(s);     
    }

     /** Creates a new instance of UpdateModeOld by deep copy.
     *@param em existing UpdateModeOld
      */
    public UpdateModeOld(UpdateModeOld em) {
        value = em.value;        
    }
