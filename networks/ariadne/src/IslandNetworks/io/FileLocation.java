...
//    private String subDirectory; // subDirectory name e.g. aegean34sl_v1_3e-1.0m0.5j0.0k1.0l1.0b1.2s50.0MC/
    ...
    /**
     * String indicating start of sequence number in filenames
     */
    private static final String SEQIND = "_r"; // indicates start of sequence number in filenames
    /**
     * String indicating start of parameter sequence in directory and filenames
     */
    private static final String PARAMIND = "_p";
    //public boolean autoNameRoot = true; // used to generate automatic addition to getNameRoot()

    /**
     * Initialise all values from given strings and given number.
    ...
    /**
     * Initialise all values from given strings except for sequence number.
    ...
    /**
     * Initialise all values except sequence number from given strings.
     * <br>No sequence number will be used in file names
     * @param dr stem for all directories
    *@param d full subDirectory name
    *@param nr stem for all file names
    ...
    /**
     * Initialise all values from full file name including extension.
     * <br>No sequence number will be used in file names
     * @param f file of 
         */
    ...
    */
    ...
    public void setSubDirectory(String d){
     ...
     public void setFirstFreeSequenceNumber() { 
        ...
        {
            if ((s.length()>0) && (s.indexOf('_')>-1)) throw new RuntimeException("Must have finite string with no _, was given "+s);
            basicRoot=s;
            return true;
        }
        /*
