...
//import java.io.*;
import IslandNetworks.run.NetworkGenerator;
...
//            ma.FileOutputStatistics(a.outputFile);
     ...
     */
    public static void testGUIDirectMC(islandNetwork a){
            ...
            //a.inputFile.setNameRoot("viking134g17LSN" );
            a.inputFile.setNameRoot("aegean39S1L3a" );
            //a.inputFile.setNameRoot("testRW3" );
            a.updateMode.setFromName("MC");
            a.betaInitial=1e-3;
            a.Hamiltonian.lambda=4.0;
            a.Hamiltonian.distanceScale=100;
            a.getSiteData();
            a.dataread =true;
     ...
     * @param a input islandNetwork
     */
    public static void testGUIDirectRW(islandNetwork a){
                // go straight to running
            a.outputMode.setAllOn();
            //a.inputFile.setNameRoot("testaegean5" ); a.
            //a.inputFile.setNameRoot("testaegean5b" );
            ...
            //InputParameterFrame iw = new InputParameterFrame(a);
            a.setOutputFileName();
            System.out.println("in TestAegean testGUIDirect before doRW");
            //a.doMC();
            a.doRW();
            //a.calcNetworkStats(); This is in showNetwork
            System.out.println("in TestAegean testGUIDirect before showNetwork");
...
public static void test5(islandNetwork a)
 ...
 //                  System.out.println("Finished edge sweep "+i);
              ...
              a.calcNetworkStats();
              //a.FileOutputPajek("#",siteSizeFactor,edgeWidthFactor, minColourFrac,zeroColourFrac,0);
              //a.FileOutputPajek("#",siteSizeFactor,edgeWidthFactor, minColourFrac,zeroColourFrac,1);
              //a.FileOutputPajek("#",siteSizeFactor,edgeWidthFactor, minColourFrac,zeroColourFrac,2);
              int maxEdgeWidthSize=10;
              boolean colourOn=true;
              a.FileOutputPajek(islandNetwork.COMMENT, maxEdgeWidthSize, colourOn) ;
              a.FileOutputGraphMLNetwork(islandNetwork.COMMENT, 
                      maxEdgeWidthSize, colourOn);
              a.FileOutputBareNetwork("#",islandNetwork.SEPSTRING);
