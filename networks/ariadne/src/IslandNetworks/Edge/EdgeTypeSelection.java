...
public class EdgeTypeSelection{
 ...
 public static final String[] name =  {IslandEdge.name[IslandEdge.valueINDEX],
                                       ...
                                       IslandEdge.name[IslandEdge.influenceWeightINDEX],
                                       IslandEdge.name[IslandEdge.betweennessINDEX],
                                       IslandEdge.name[IslandEdge.influenceprimeWeightINDEX],
                                       IslandEdge.name[IslandEdge.betweennessprimeINDEX],
                                       IslandEdge.name[IslandEdge.nbetweennessINDEX],
                                       IslandEdge.name[IslandEdge.nbetweennessprimeINDEX] };
