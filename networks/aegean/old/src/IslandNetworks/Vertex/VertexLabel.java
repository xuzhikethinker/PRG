...
//     Rank rank;
        ...
        public VertexLabel()
        {
          name="";
          strength=0;
          position=new VertexCoordinate ();
//          rank = new Rank();
        }
        
        public VertexLabel(double setstrength, VertexCoordinate  setposition )
        {
          name="";
...
//          rank = new Rank();
        ...
        public VertexLabel(String setname, VertexCoordinate  setposition )
        {
          name=setname;
          strength=0;
          position=setposition;
//          rank = new Rank();
        ...
        public VertexLabel(String setname, double setstrength, VertexCoordinate  setposition )
        {
          name=setname;
          strength=setstrength;
          position=setposition;
//          rank = new Rank();
        ...
        public VertexLabel(VertexLabel oldVertexLabel )
        {
          ...
          position = new VertexCoordinate  (oldVertexLabel.position);
//          rank = new Rank();
        }
        ...
        public String pajekString(VertexCoordinate  min, VertexCoordinate  max)
        {            
