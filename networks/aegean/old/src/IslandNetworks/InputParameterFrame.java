 ...
 */
    ...
    public InputParameterFrame(islandNetwork inetinput) {
        ...
        inputFrame.setIconImage(new AriadneIcon().getPot16());
...
//            if (command.equals("M")) updateMode=1;
        ...
        mcHotStartCB= new JCheckBox("Hot MC Start");
        mcHotStartCB.setSelected(true);
        inputPanel.add(mcHotStartCB);
...
//        else i.Hamiltonian.beta=1.0;
        ...
        String zCFInitial = " "+i.edgeSet.zeroColourFrac;
        ...
        String mCFInitial = " "+i.edgeSet.minColourFrac;
