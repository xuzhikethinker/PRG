...
//        VertexValueSelection vertexValueSelection;
    ...
    // UserData keys now use the VertexValueSelection names
//    public static final String SIZ_key = "IN_SIZKey"; // weight
//    public static final String RANK_key = "IN_RANKKey"; // rank
//    public static final String INFL_key = "IN_INFLKey"; // influence
//    public static final String STRIN_key = "IN_STRINKey"; //strength in

//    public static final String EV_key = "IN_EVKey";
    ...
    private void addAllEdges(){
     ...
     for(int i=0;i<inet.siteSet.getNumberSites();i++) {
            for(int j=0;j<inet.siteSet.getNumberSites();j++) {
                if (inet.edgeSet.displayZeroEdgeWeight>inet.edgeSet.getEdgeWeight(i, j)) continue;
