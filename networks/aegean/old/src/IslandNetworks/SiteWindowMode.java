...
public class SiteWindowMode {
 ...
 public static String[] SiteWindowModeArray =  {"Numerical", "Weight", "Rank", "Alphabetical", "Rank/Weight", "Influence"}; 
 public static int numberTypes = SiteWindowModeArray.length;
 public int value=0;
