...
//        }
        ...
        //a.inputGUI =false; a.inputnameroot="testsimple"; System.out.println(" $$$ test5 only");
        
        
        if (a.inputGUI) 
        {
            // if no command line input file name then read in from Window
//            if (a.inputnameroot == oldinputnameroot) 
//            {
//                //InputFileWindow ifw = new InputFileWindow(a.getInfomationLevel());
//                newArgs = new String[args.length+2];
//                int i=0;
//                for (i=0; i<args.length; i++) newArgs[i]=args[i]; 
//                newArgs[i++]="-fi"+ifw.inputNameRoot;
//                newArgs[i++]="-fj"+ifw.jiggleScale;
//            }
//            else 
//            {
...
//            a.showNetworkStatistics("#",System.out,3);
            ...
            ma.readVariableRanges(a.inputnameroot);
            ma.calcRange(a);
            ma.FileOutputStatistics(a.inputnameroot+"_v"+a.modelNumber.major+"_"+a.modelNumber.minor);
        }
