...
//        final static LookAndFeel lookAndFeel = new LookAndFeel("System");  
        ...
        final static String iNVERSION = "iN080414";
        ...
        //FileName inputFileNameRoot;
        final static String inputFileEnding="_input";
//        final String parameterFileEnding="_parameter";
        //FileName outputFileNameRoot;
...
//        int modelNumber.major;
//        int modelNumber.minor;
//        boolean modelNumber.bit0; // use these to record bits of the modelNumber.minors
//        boolean modelNumber.bit1;
//        boolean modelNumber.bit2;
        ...
        //boolean newNetworkDisplaySyle = false;
        ...
        static Random rnd;
//        double MAXSEPARATION = 9999999.9;
        double MAXH = 1e6;
...
// for (int i =0; i<numberSites; i++) { siteArray[i].size=-88.0;  siteArray[i].value=-89.0;};
        ...
        // Now Hamiltonian coefficients
           ...
           // update records zeroed on construction
             ...
             vertexMaximum=5.0; //Math.max((DisplayMaxVertexScale>0?DisplayMaxVertexScale:5.0), 1.0);
...
//        maxvedgeweightindex =islnetinput.maxvedgeweightindex ; 
    ...
    {
        rnd = new Random(); // Give long integer arg else uses time to set seed
        executeMode = new ExecuteMode(inparam.executeMode);
 ...
 *@param islnetinput is an inout islandNetwork to be deep copied to new one.
    */
    ...
    {        
        ...
        modelNumber = islnetinput.modelNumber;
    }
...
//                else  autoSetOutputFileName=false;
         ...
         */
            public void Usage(){
                ...
                System.out.println("  -u<updateMode>    Sets update mode, 0 PPA, 1 MC, 2 DP, 3 VP, default "+i.updateMode);
                ...
                System.out.println("  -x<vertexMaximum> Sets edge max vertex value, default "+i.vertexMaximum);
 ...
 // -------------------------------------------------------------------
  ...
  /**
    ...
    {    
          ...
          PS.print(SEPSTRING+ "-u"+updateMode);
          PS.println(SEPSTRING+ "-x"+vertexMaximum);
...
// .....................................................................
    ...
    {
        double newVertexValue=  rnd.nextDouble()*vertexMaximum; 
...
//                 if (MChistory) {calcEnergy();mch.add(beta,energy,vertexUR.made, edgeUR.made);}
    ...
    /**
     * Tests change in energy due to veretx change.
