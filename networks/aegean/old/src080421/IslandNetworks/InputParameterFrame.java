 ...
 */
    ...
    public InputParameterFrame(islandNetwork inetinput) {
        ...
        inputFrame = new JFrame("Inputs for "+inet.inputFile.getFullFileRoot()+ " Ariadne Network"+ islandNetwork.iNVERSION);
...
//        fileOutputValue = new JTextField(outputFile.getBasicRoot().substring(0,15),16);
        ...
        if (inet.updateMode==0) i.Hamiltonian.beta=3.0;
...
//        jLabel.setBorder(BorderFactory.createEmptyBorder(5,5,5,5));
    ...
    { 
        public void actionPerformed(ActionEvent e) 
        {
            ...
            if (command.equals("P")) inet.updateMode=0;
            if (command.equals("M")) inet.updateMode=1;
            if (command.equals("D")) inet.updateMode=2;
            if (command.equals("V")) inet.updateMode=3;
            ...
            if (command.equals("SWNum")) inet.siteWindowMode = 0;
            if (command.equals("SWAlpha")) inet.siteWindowMode = 3;
            if (command.equals("SWWeight")) inet.siteWindowMode = 1;
            if (command.equals("SWRank")) inet.siteWindowMode = 2;
            if (command.equals("SWRankOverWeight")) inet.siteWindowMode = 4;
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        try
        {
            ...
            inet.vertexMaximum = Double.parseDouble(maxVertexValue.getText());
