...
public class Aegean {
    ...
    public static void main(String[] args) {
        ...
        if (a.inputGUI) a.runGUI();
             ...
             {
                 NetworkGenerator ng =new NetworkGenerator(a.generateType,a.generateNumber,a.distScaleH);
                 ng.FileOutputSite(2);
                 return;
             }
...
//                else {System.out.println("Update Mode is MC");
            ...
            a.infolevel=-1; // switch off outputs
            ma.readVariableRanges(a.inputnameroot);
            ma.calcRange(a);
            ma.FileOutputStatistics(a.inputnameroot);
        }
