...
//import TimUtilities.LookAndFeel;
        ...
        /** 
         * Window asking for input file name.
         * <p>This is the parent window for GUI running of islandNetwork.
...
// --- createAndShowNetWin
    ...
    protected static Image getFDImage(String name) {
        java.net.URL imgURL = InputDataFrame.class.getResource(name);
        if (imgURL != null) {
     ...
     private void createAndShowIDF() {
        //Assume Look and Feel already set
        ...
        infileFrame.setIconImage(new AriadneIcon().getPot16());
        
//      infileFrame.setIconImage(new ImageIcon("images/pot16.gif").getImage());
//infileFrame.setIconImage(getFDImage("images/pot16.gif"));
//        infileFrame.setIconImage(Toolkit.getDefaultToolkit().createImage
//                            (GraphicsJFrame.class.getResource("images/pot16.gif")));//set application icon
//or
//   Toolkit toolkit = Toolkit.getDefaultToolkit();
//   Image icon = toolkit.getImage(getClass().getResource("images/pot16.gif"));
//   infileFrame.setIconImage(icon); //see here
...
//        String citeString2="<html><body>hello world</body></html>";
...
//        JOptionPane.showMessageDialog(infileFrame, citeString,  "ariadne Licence", JOptionPane.INFORMATION_MESSAGE);

        Licence.showCiteMessageDialog(infileFrame);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        try
        {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                inet.message.infoWarningBox(-1,infileFrame, "Can not find file "+inet.inputFile.getNameRoot(),"Input File Warning");
            }
            }// if openbutton
