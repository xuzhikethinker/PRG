...
//        in.inputFile.setAll("input/", "", "circleN16D150.0plaw2.000R-J50.0", "", 0, "_input","dat");
        
        File ifl;  
        if (args.length>0) { in.Parse(args); ifl = new File(in.outputFile.getFullLocationFileName("",islandNetwork.NETWORKDATAFILEEXT));}
        else {
