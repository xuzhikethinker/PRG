...
/**
 * Given standard site data creates edges and analyses single network.
 * For analysis of existing data files or for debugging.
 * @author time
 */
public class FixedParameterAnalysis {
    
    /**
     * Creates a network from given input file.
     * For analysis of existing data files or for debugging.
    ...
    public static void main(String[] args) {
        ...
        //String [] aList={"-Eariadne", "-fibaegean10S1L3a", "-uPPA", "-bt3.0"};
            ...
            String rootname="circleN16D150.0plaw2.000R-J50.0";
