...
//            }
            ...
            inputFile = new FileLocation(ariadneDirectory+"/input/", "", "aegean39S1L3a", "", "_input", "dat");
            outputFile = new FileLocation(ariadneDirectory+"/output/", "", "aegean39S1L3a", "", 0, "", "dat");
            //runname="r0";
...
// -------------------------------------------------------------------
  /**
     ...
     * 
     */
    public void FileOutputBareNetwork(String cc){
