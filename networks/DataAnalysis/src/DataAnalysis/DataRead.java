...
/**
 * Reads in file with fixed number of columns of numerical data.
 * Uses a header line to fix labels and number of columns.
 * Allows for comment lines.
 * Data given as doubles.
 * @author time
 */
public class DataRead {
    
    int infolevel=0;
    private int numberDataColumns=0; // number of columns in total
    private int totalNumbersOfDataLines=0; // number of data entries
    ...
    // ----------------------------------------------------------------------
        /** 
         * Reads in data from file <kbd>filename</kbd>.
         ...
         * @param dirname name of directory to read data
         * @param cc used for comments, first character used only
         * @param labelLine that starts the line of column labels
    ...
    public int getData(String filename, String dirname, String cc,  String labelLine, int numberColumnsToBeRead, int [] columnsToBeRead) 
    {
        ...
        return res;
           ...
           /**
            *  Returns total numbers of data lines.
            ...
            */           
           public int getNumberDataColumns() {
               return numberDataColumns;
           }
