...
def box_analysis(N, D, num_boxes, out, count):
    ...
    for box in boxes:
        ...
        out.write('\n' + 'The start node is %s and the end node is %s' %(extremal_points[0], n))
...
if __name__ == "__main__": 
    ...
    #count.write("Counter1 = %s + '\n'" % counter1)
    #count.write("Counter2 = %s + '\n'" % counter2)
    #count.write("Counter3 = %s + '\n'" % counter3)
