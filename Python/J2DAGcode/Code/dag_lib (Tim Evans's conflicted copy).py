...
def box_generator(N, D, type='box'):
    ...
    # This is N-2 as we always want points at (0, 0, 0, ...) and (1, 1, 1, ...) ie. the corners of the box
        box_list.append([])
    ...
    # box_list is now a N-2 length list of points, which are D length lists of co-ords  
    ...
    extremes = [box_list[-1], box_list[-2]]
