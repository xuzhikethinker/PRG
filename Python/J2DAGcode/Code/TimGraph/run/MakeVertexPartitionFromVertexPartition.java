...
//     tg = new timgraph();
//     tg.parseParam(aList);
////     if (!tg.isVertexVertexListOn()) System.err.println("\n *** Vertex Vertex List NOT on and it is required, use -vgvet option ***\n");
...
//     }
     ...
     makePartition(tg, vpFilename, vertexIndexColumn, partitionIndexColumn,
             edgeWeightMinimum,
             indexString, graphMLOutput, headerOn ,vpInformationOn );
 ...
 * @param vertexIndexColumn column with the index of the vertex
 * @param vertexCommunityColumn column with the community label of the vertex
 * @param edgeWeightMinimum only edges of this weight or larger displayed
 * @param indexString true (false) if the index column is a name (an integer vertex index)
 * @param graphMLOutput true if want graphML output
 * @param headerOn true (false) if header row starts vp file.
 * @param vpInformationOn true (false) if want infromation on vp based on graph
 */
   static public void makePartition(timgraph tg, String vpFilename,
                                    ...
                                    boolean indexString, boolean graphMLOutput,
...
//     }
     ...
     if (graphMLOutput) fo.graphML(vp.getCommunityName(c)+"B", edgeWeightMinimum);
