...
public class Quality {
    ...
    public final static String [] nullModelString = {"out-out", "in-out", "out-in", "in-in", "Pi-Pi"};
   ...
   public void initialisePreAdjacencyMatrix(timgraph graph, int qdef, double newlambda, int infoLevelNew){
        ...
        if (graph.isDirected()) nullModelSwitch=4;
        else nullModelSwitch=0;
    }
    /**
     ...
     */
    public String getNullModelDescription(){return nullModelString[nullModelSwitch];}
