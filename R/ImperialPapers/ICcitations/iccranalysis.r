...
print(paste("parameterAnalysisOn",parameterAnalysisOn), quote=FALSE)
if (plotsOn){ 
...
for (iii in 1:length(unitList)) {
 ...
 CRList[[iii]] <- citationReferenceIndex8(refList, citeList, binSize[[iii]], minCount, normalise, cNotCoverR, numberParameters) 
}
