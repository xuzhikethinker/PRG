...
readRCYfile <- function(fullName, headerOn=TRUE, sepString="\t", refColumn, citeColumn, yearColumn, dateColumn=-1, typeColumn=-1) {
...
citations <- read.table(paste("data/",fullName,sep=""), header=headerOn, sep=sepString);
