...
minYear=1996 #1996 for depts #1997 for facs #1997 for arXiv
maxYear=2007 #2007           #2007          #2004 
...
if(calcZCorrel){
calcZCorrelations(rootName,  facultyNotDept, arXiv,minYear, maxYear,plotsOn =TRUE,
...
{ 
    yyy <- yearList[[iii]] 
    lst <-iccranalysis(rootName, cNotCoverR, normalise, facultyNotDept, arXiv, allData, yyy, yyy+binnedYears-1, numberParameters, parameterAnalysisOn, plotsOn, OSWindows, screenOn, pdfPlotOn, epsPlotOn,minCoverMeanC) 
