...
print(paste("N=",Nvalue,", p=",pvalue,", <k>=",kaverage), quote=FALSE)
...
# Set x axis
xLabel = paste("k/(<k>-",graphKfitShift,")",sep="")
...
# Set y axis
#yLabel = paste("log(n(k)*p*(<k>-",graphKfitShift,")")
graphpPowerShift=0.85
yLabel = paste("log(n(k)*p^",graphpPowerShift,"*(<k>-",graphKfitShift,") )",sep="")
ynorm=1:length(ResultsList)
