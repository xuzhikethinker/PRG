...
prlist=1-pporiginallist;

source("rwlpdf.r");
source("ddpdf.r");
p1llpe=plot(ddpdf(1,398,398,1.99,prlist[1]), type="l", log="xy" , col=colourlist[1], ylim=c(1e-9,1), xlab="degree k", ylab="p(k)", main="Laird and Jensen EPL 2006 Fig 1 (ll, orig)");
