...
#Fit but assume that b=-(N-1)
source("ratiofitac.r")
rm(fit010,fit250,fit750,fit950,fit990,fit999)
bvalue <- -199
#print("Fitting s010r")
#fit010 <- ratiofitac(s010r, 398, 1.99, 0.8,   bvalue, 0)
print("Fitting s250r")
fit250 <- ratiofitac(s250r, 398, 1.99, 0.8,   bvalue, 0)
print("Fitting s750r")
fit750 <- ratiofitac(s750r, 398, 1.99, 0.362, bvalue, 1)
print("Fitting s950r")
fit950 <- ratiofitac(s950r, 398, 1.99, 0.095, bvalue, 1)
print("Fitting s990r")
fit990 <- ratiofitac(s990r, 398, 1.99, 0.028, bvalue, 1)
print("Fitting s999r")
fit999 <- ratiofitac(s999r, 398, 1.99, 0.012, bvalue, 0)
