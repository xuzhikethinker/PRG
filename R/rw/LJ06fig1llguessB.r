...
source("ddpdfabc.r");
i <- 1;
p1llguess=plot(ddpdf(1,199,199,1.99,prlist[1]), type="l", log="xy" ,  col=colourlist[i], ylim=c(1e-9,1), xlab="degree k", ylab="p(k)", main="Laird and Jensen EPL 2006 Fig 1 (ll, E=199, K=1.99, pr guess B)");
